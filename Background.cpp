...
void Background::Draw(Screen& screen, int bg1, int bg2, int bg3, int bg5, int bg6, int bg7)
{
	...
	Novice::DrawSprite(0 - screen.Scroll.x * 0.8, 532 + screen.Scroll.y * 0.35, bg7, 1, 1, 0, WHITE);
	Novice::DrawSprite(0 - screen.Scroll.x * 0.8, 436 + screen.Scroll.y * 0.42, bg6, 1, 1, 0, WHITE);
